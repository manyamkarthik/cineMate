          ...
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            >
              <img
                ...
                title="CineMate Logo"
              />
              <span className="self-center text-2xl font-extrabold text-gray-900 dark:text-white tracking-tight hover:text-red-500">
                Cine<span className="text-blue-500">Mate</span>
              </span>
            </Link>
            ...
            <div className="flex md:order-2">
              ...
              <button
                ...
                className="text-gray-700 dark:text-gray-300 text-2xl p-2 mr-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700"
